...
class mr_master(mrj):
    ...
    def mapper_init_create_vectors(self):
        ...
        '''
        c = boto.connect_s3("AKIAJL3NE6TPITICJYIQ","9uMHikvM12Y7KPB5aarHFuhZViL0sw9px4IoEaq4")
        bucket = c.get_bucket("cs-123-css")
        key = bucket.get_key("add_to_s3.json")
        key = key.get_contents_to_filename("json.dict")

        with open("json.dict",'r') as f:
